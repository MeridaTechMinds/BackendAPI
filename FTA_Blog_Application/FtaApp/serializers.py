...
class Quastion_modelSerializer(serializers.ModelSerializer):
    class Meta:
        model =Quastion_model
        fields = '__all__'

class Get_in_Touch_Serializer(serializers.ModelSerializer):
    class Meta:
        model =Get_in_Touch
        fields = '__all__'
...
class Contact_table_Serializer(serializers.ModelSerializer):
    class Meta:
        model =contact_table
        fields = '__all__'